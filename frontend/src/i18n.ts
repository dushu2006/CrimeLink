...
export const STRINGS: Record<string, Record<Lang, string>> = {
  ...
  "nav.investigateRelationship": {
    en: "Investigate Relationship",
    hi: "संबंधों की जाँच करें",
    te: "సంబంధాలను పరిశోధించండి",
    ta: "தொடர்புகளை விசாரிக்கவும்",
  },
  "nav.investigatorActivity": {
    en: "Investigator Activity",
    hi: "जाँचकर्ता गतिविधि",
    te: "పరిశోధకుడి కార్యాచరణ",
    ta: "புலனாய்வாளர் செயல்பாடு",
  },
  "nav.patterns": {
    en: "Patterns",
    hi: "पैटर्न",
  ...
  "nav.audit": {
    en: "Audit / Activity",
    hi: "ऑडिट और गतिविधि",
    te: "ఆడిట్ మరియు కార్యాచరణ",
    ta: "தணிக்கை & செயல்பாடு",
  },
  "nav.cases": {
    en: "Cases",
    hi: "प्रकरण",

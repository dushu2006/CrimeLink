...
// The dataset lifecycle lives in its own component: upload, import progress,
// activation and graph builds are one workflow, and Administration should not
// carry a second, divergent copy of it.
...
export default function Admin() {
  ...
  const TAB_LOADERS: Record<AdminTab, (() => void) | null> = {
    dataset: null, // DatasetConsole loads /datasets itself
  ...
  return (
    <div className="page">
      ...
      {tab === "dataset" && <DatasetConsole jurisdictionId={session?.jurisdiction_id} />}
